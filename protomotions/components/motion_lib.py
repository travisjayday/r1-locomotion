...
class MotionLib:
    ...
    **Example:**
    ...
    # Procedurally generated, manually editable locomotion-command annotations.
    simulation_root_pos: Optional[torch.Tensor] = None
    simulation_root_rot: Optional[torch.Tensor] = None
    simulation_root_vel: Optional[torch.Tensor] = None
    simulation_root_ang_vel: Optional[torch.Tensor] = None
    motion_commands: Optional[torch.Tensor] = None  # body-frame [vx, vy, yaw_rate]
    achieved_motion_commands: Optional[torch.Tensor] = None
    source_motion_commands: Optional[torch.Tensor] = None
    motion_command_metadata: Optional[dict] = None
    ...
    def _create_empty(self):
        ...
        self.simulation_root_pos = None
        self.simulation_root_rot = None
        self.simulation_root_vel = None
        self.simulation_root_ang_vel = None
        self.motion_commands = None
        self.achieved_motion_commands = None
        self.source_motion_commands = None
        self.motion_command_metadata = None
