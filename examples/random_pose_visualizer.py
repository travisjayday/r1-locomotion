...
class RandomPoseVisualizer:
    def __init__(
        ...
        # Disable gravity at the scene level for IsaacLab. The asset-level
        # disable_gravity flag can depend on USD nested-schema propagation;
        # zero scene gravity is explicit and applies to every articulation link.
    ...
    def run(self):
        ...
        while True:
            ...
            if self.simulator.user_requested_reset:
                ...
                # Consume the initial/key-triggered request. Leaving this true
                # regenerates and resets the robot every render frame instead
                # of waiting for the next R key press.
