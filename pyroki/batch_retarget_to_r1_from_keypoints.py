...
def get_humanoid_retarget_indices() -> jnp.ndarray:
    ...
    r1_joint_retarget_indices = []

    # NOTE: the order matters here.
    for human_name, r1_name in [
        ("pelvis", "pelvis_link",
        ...
        r1_joint_retarget_indices.append(R1_LINK_NAMES.index(r1_name))

    r1_joint_retarget_indices = jnp.array(r1_joint_retarget_indices)

    return human_retarget_names, r1_joint_retarget_indices


human_retarget_names, r1_joint_retarget_indices = None, None
...
def main():
    ...
    parser.add_argument(
        "--mesh-dir",
        type=str,
        default=str(SCRIPT_DIR / "../protomotions/data/assets/mesh/R1"),
    ...
    if R1_LINK_NAMES is None:
        R1_LINK_NAMES = list(robot.links.names)

    global human_retarget_names, r1_joint_retarget_indices
    human_retarget_names, r1_joint_retarget_indices = get_humanoid_retarget_indices()

    current_motion_index = 0

    # Create connectivity matrix for the G1 joints
    n_retarget = len(r1_joint_retarget_indices)
    ...
    if args.visualize:
        ...
        def generate_trajectory():
            ...
            Ts_world_root, joints = solve_retargeting(
                ...
                g1_joint_retarget_indices=r1_joint_retarget_indices,
...
def solve_retargeting(
    ...
    def pc_alignment_cost(
        ...
        # torso aux link
        torso_idx = R1_LINK_NAMES.index("torso_link")
